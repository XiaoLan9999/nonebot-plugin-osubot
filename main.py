...
from .astrbot_src.utils import load_help_data, get_info, validate_osu_mode, to_track_mode
from .astrbot_src.client import LinkAccountManager, OAuthClient, OsuApiClient, TokenManager
from .astrbot_src.osutrackapi import OsuTrackApi, StatsUpdate, RecordedScore, PeakData
...
class OsuTrackPlugin(Star):
    ...
    async def _start_news_push(self):
        ...
        from .astrbot_src.osuapi import OsuClient
